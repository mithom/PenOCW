...
def get_function_ids():
    function_ids = {'go_straight':id(go_straight), 'make_circle_left':id(make_circle_left), 'make_circle_right':id(make_circle_right), 'rotate_angle_left':id(rotate_angle_left), 'rotate_angle_right':id(rotate_angle_left),
                    'set_left':id(set_left), 'set_right':id(set_right), 'turn_straight_left':id(turn_straight_left), 'turn_straight_right':id(turn_straight_right)}
    return function_ids
